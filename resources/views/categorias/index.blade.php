        ...
        @foreach($categorias as $categoria)
            <form name="formEdtCat" method="post" action="{{url("categorias/$categoria->id")}}">
                ...
                <tr>
                    ...
                    <td>
                        <div class="text-end">
                            <button type="submit" class="btn btn-outline-success mx-2" id="{{$categoria->id}}" onclick="EditConfirm();"
                                    disabled><i
                                    class="fa-light fa-pen-to-square fa-sm"></i> Editar
                            </button>
                            <button type="button" class="btn btn-outline-danger mx-1 delete" onclick="Delete('{{url("categoriaDelete/$categoria->id")}}');"><i class="fa-light fa-trash fa-sm"></i> Remover</button>
                        </div>
                    </td>
                </tr>
            </form>
